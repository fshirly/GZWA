...
<body>
	...
	src="${pageContext.request.contextPath}/js/platform/managedDomain/managedDomainAdd.js"></script>
	...
	<div id="divManagedDomainInfo" >
		...
		<table id="tblEditDomain" class="formtable1">
			...
			<tr>
				...
				<td><textarea id="ipt_domainDescr" rows="3" class="input" validator="{'length':'0-200'}" ></textarea></td>
				
			</tr>
		</table>
		<div class="conditionsBtn">
			<input class="buttonB" type="button" id="btnSave" value="确定" onclick="javascript:doAddManagedDomain();"/>
