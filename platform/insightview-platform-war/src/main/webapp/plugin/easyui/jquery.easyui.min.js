 ...
 *修改内容：_84和tr赋值
 */
var _84=$(_81).addClass("pagination").html("<div class=\"pagination-info\" style=\"float:left\"></div>");
var tr=$("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"float:right\"><tr></tr></table>").appendTo(_84).find("tr");
...
var _87=aa[_86];
if(_87=="list"){
var ps=$("<select class=\"pagination-page-list\" style=\"margin-left:5px\"></select>");
...
var perPage = $("<span style='padding-left:6px;'>每页显示:</span>");
$("<td></td>").append(perPage).append(ps).appendTo(tr);
}else{
if(_87=="sep"){
...
//$("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" float=\"right\"><tr></tr></table>").appendTo(_84);
...
/*修改时间：2014-7-18
 *修改内容：修改分页按钮排列方式，layout中元素排列
 *修改人：zhaoyp
 */
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","next","last","sep","manual","refresh"],onSelectPage:function(_a6,_a7){
...
cc.push("<span class=\"tree-title\" title=\""+opts.formatter.call(_198,item)+"\">"+opts.formatter.call(_198,item)+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
var _1ed=$("<div class=\"panel-header\"><div class=\"panel-title\" title=\""+opts.title+"\">"+opts.title+"</div></div>").prependTo(_1ec);
if(opts.iconCls){
_1ed.find(".panel-title").addClass("panel-with-icon");
$("<div class=\"panel-icon icon iconfont\"></div>").addClass(opts.iconCls).appendTo(_1ed);
}
...
$.fn.accordion.defaults={width:"auto",height:"auto",fit:false,border:true,animate:false,multiple:false,selected:0,onSelect:function(_2d0,_2d1){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6c3,_6c4){
		...
		if ($(this).is('select')) {
			...
			if (opts.url || opts.data) {
				...
				$.each(options,function(i,option){
					var defaultItem = {};
					defaultItem[valueField] = option.value;
					defaultItem[textField] = option.text;
					orignalData.push(defaultItem);
				});
				
				return orignalData.concat(data);
			}
		}
		return data;
	}
