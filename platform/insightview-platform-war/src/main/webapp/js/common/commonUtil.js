...
if(window.fb===void(0)){
    window.fb = {
        getHtmlArg:function(name,defaultValue){
        ...
        state : function(room,seat,person){
...
fb.fbMode =fb.getHtmlArg("fbMode",0);
...
function checkInfo(divId){
    ...
    $(divId+" [validator]").each(function() {
        ...
        if(!validator || validator===void(0) ||validator=="") return;
