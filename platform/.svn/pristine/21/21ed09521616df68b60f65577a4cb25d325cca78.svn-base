				...
				<form id="form1">
					...
					<table class="formtable1">
						<tr>
							...
							<td><input type="text" class="inputVal" id="startTime" name="startTime" onfocus="new WdatePicker({dateFmt:'yyyy-MM'})"  value="${userTrainingExp.startTime}" validator="{'length':'1-20'}"/><dfn>*</dfn></td>
						</tr>
						<tr>
                            <td class="title">结束年月：</td>
                            <td><input type="text" class="inputVal" id="endTime" name="endTime" onfocus="new WdatePicker({dateFmt:'yyyy-MM'})"  value="${userTrainingExp.endTime}" validator="{'length':'0-20'}"/></td>
                        </tr>
						<tr>
	                        <td class="title">培训及后续教育：</td>
	                        <td><input id="followUpWork" class="inputVal" name="followUpWork" value="${userTrainingExp.followUpWork}"  validator="{'length':'1-200'}"/><dfn>*</dfn></td>
	                    </tr>
                        <tr>
                            <td class="title">证明人：</td>
                            <td><input id="reference" class="inputVal" name="reference" value="${userTrainingExp.reference}"  validator="{'length':'0-50'}"/></td>
                        </tr>
					</table>
