				...
				<form id="form1">
					...
					<table class="formtable1">
						<tr>
							...
							<td><input type="text" class="inputVal" id="startTime" name="startTime" onClick="WdatePicker({dateFmt:'yyyy-MM'});"  value="${userLearningExp.startTime}" validator="{'length':'1-20'}"/><dfn>*</dfn></td>
						</tr>
						<tr>
                            <td class="title">结束年月：</td>
                            <td><input type="text" class="inputVal" id="endTime" name="endTime" onClick="WdatePicker({dateFmt:'yyyy-MM'})"  value="${userLearningExp.endTime}" validator="{'length':'0-20'}"/></td>
                        </tr>
						<tr>
	                        <td class="title">毕业院校及系、专业：</td>
	                        <td><input id="eduAndMajor" class="inputVal" name="eduAndMajor" value="${userLearningExp.eduAndMajor}" validator="{'length':'1-200'}"/><dfn>*</dfn></td>
	                    </tr>
	                    <tr>
                            <td class="title">证书类型：</td>
                            <td><input id="graduationInfo" class="inputVal" name="graduationInfo" value="${userLearningExp.graduationInfo}" style="width:182px" validator="{'length':'0-50'}"/></td>
                        </tr>
                        <tr>
                            <td class="title">证明人：</td>
                            <td><input id="reference" class="inputVal" name="reference" value="${userLearningExp.reference}" validator="{'length':'0-50'}"/></td>
                        </tr>
					</table>
